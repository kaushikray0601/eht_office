...
TRACER_FIELD_MAPPING = {
    ...
    'SR_Parallel_Run_Basis': 'sr_parallel_run_basis',
    'SR_Constructability_Warning': 'sr_constructability_warning',
    'SR_Per_Run_Tracer_Length': 'sr_per_run_tracer_length',
...
def fetch_project_data(project_id):
    ...
    return {
        ...
        "sr_parallel_run_basis": project_data.sr_parallel_run_basis,
        "sr_max_parallel_runs": int(project_data.sr_max_parallel_runs),
...
def store_calculated_results(project_id, aggregated_results):
    ...
    for item in aggregated_results.get('tracer_power_param', []):
        ...
        process_line_calc_rows.append(ProcessLineCalculation(
            ...
            pipe_size_mm=normalized_item.get('pipe_size_mm', 0),
            spiral_factor=spiral_factor,
            sr_parallel_run_count=normalized_item.get('sr_parallel_run_count', 1),
