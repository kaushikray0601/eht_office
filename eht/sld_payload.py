...
def _cold_cable_metadata_for_node(node, result):
    ...
    return {
        ...
        'startup_vd_total_pct': result.startup_vd_total_pct,
        'startup_vd_threshold_pct': result.startup_vd_threshold_pct,
        'startup_vd_status': result.startup_vd_status,
        'per_circuit_starting_current_a': result.per_circuit_starting_current_a,
