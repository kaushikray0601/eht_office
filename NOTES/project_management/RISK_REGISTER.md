...
| R-002 | Cold-cable installation methods are exposed before catalogue coverage is complete. | Medium | High | Add catalogue readiness and UI guidance in `CC-P1`. | Open |
